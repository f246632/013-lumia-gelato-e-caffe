...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Console Message
    // ===========================
    console.log('%c🍨 Lumia Gelato e Caffé 🍨', 'font-size: 20px; font-weight: bold; color: #d4a574;');
    console.log('%cArtisanal Italian Gelato in Berlin', 'font-size: 14px; color: #8b6f47;');
    console.log('%c100% Natural • Vegan Options • Gluten-Free', 'font-size: 12px; color: #666;');
});
